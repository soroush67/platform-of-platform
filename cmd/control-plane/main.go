...
func main() {
	...
	listProjectsService := tenancyapp.NewListProjectsService(projectRepo, membershipRepo, roleBindingRepo)
	getProjectService := tenancyapp.NewGetProjectService(projectRepo, membershipRepo, roleBindingRepo)
